...
class RedisService:
    ...
    def set_user_chngiq(self, user_id: str) -> None:
        self._con.set("chngiq"+user_id, "True", ex=3600)

    def get_user_chngiq(self, user_id: str) -> bool:
        return self._con.get("chngiq"+user_id) is not None
